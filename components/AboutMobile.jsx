...
const AboutMobile = () => {
    return ( 
        ...
        >
            ...
            >
              ...
              <Grid
                ...
                width={596}
              > 
            <Typography variant="body1" textAlign="left" color="#333333" fontSize={16} pt={1}>
          ...
          <Grid
                ...
                width={596}
              > 
             <Typography  variant="body1" fontStyle='italic' fontSize={14} textAlign="center" color="#333333" pt={6}>
              ...
              <Typography variant="body1"  textAlign="center" color="#333333" py={2} pb={6}>
        ...
        <Grid item lg={7} md={7} sm={9} xs={12} align="center">
          ...
          <MuiNextLink href="/menu" alignItems="center" underline="none" sx={{ mt:4}}>
            <Button 
